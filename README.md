...
- [WFGY](https://github.com/onestardao/WFGY): Open source framework for debugging and stress testing LLM coding tools and RAG pipelines with a 16-problem failure map.
