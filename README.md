...
- [Bernstein](https://github.com/chernistry/bernstein): Multi-agent orchestrator — spawns Claude Code, Codex CLI, and Gemini CLI in parallel on isolated git worktrees, verifies with tests, auto-commits working code.
