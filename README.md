...
- [Open Code Review](https://github.com/raye-deng/open-code-review): Open-source CI/CD quality gate that detects AI-generated code defects (phantom packages, outdated APIs, context breaks) invisible to traditional linters and SonarQube. Supports TypeScript, Python, Java, Go, Kotlin.
