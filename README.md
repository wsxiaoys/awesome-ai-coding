...
- [claude-carbon](https://github.com/gwittebolle/claude-carbon): Track the carbon footprint of your Claude Code sessions with a live status line, reports, and shareable cards.
