...
- [Octo Terminal](https://github.com/johunsang/octo-terminal-releases): The ultimate vibe coding terminal — AI-powered all-in-one desktop app with built-in Claude, Codex, Ollama, split terminals, code editor, notes, SSH remote, and remote control via Telegram/Discord/Slack. Built with Tauri v2 + React + Rust.
