...
- [Claude Code Mastery](https://github.com/ShipWithAI/claude-code-mastery): Comprehensive free course for mastering Claude Code with structured workflows, security, automation, multi-agent patterns, and bilingual English/Vietnamese content.
