...
- [Cursor Doctor](https://github.com/nedcodes-ok/cursor-doctor): CLI and VS Code extension that diagnoses and auto-fixes Cursor AI rule setups. Health grade, 20+ lint checks, conflict detection, and one-command repair.
