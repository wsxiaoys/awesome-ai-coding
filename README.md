...
- [BGPT MCP](https://github.com/connerlambden/bgpt-mcp): Hosted MCP server for searching scientific papers with full-text experimental data. SSE + Streamable HTTP endpoints, 50 free searches, no API key needed.
