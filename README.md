...
- [Helium MCP](https://github.com/connerlambden/helium-mcp): Remote MCP server for market intelligence, ML options pricing, and news bias analysis across 5,000+ sources. Free tier, no API key.
