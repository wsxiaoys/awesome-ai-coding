...
- [AICode](https://ai-code.ai/): Specification-first VS Code coding agent with a local 5D codebase index, MCP support, and BYOK routing to OpenAI or a private Azure tenant.
