...
- [MartinLoop](https://github.com/Keesan12/martin-loop): Open-source control plane for AI coding agents with budget caps, verifier gates, halt reasons, and inspectable run records.
