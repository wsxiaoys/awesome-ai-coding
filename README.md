...
- [Forge](https://forge-web.rebaselabs.online/): AI-powered full-stack app creator with BYOK (Anthropic, OpenAI, Google AI). Multi-stage pipeline: planning → architecture → code generation → verification.
