...
- [aicost](https://github.com/dwylq/aicost): Universal AI coding cost analyzer — scans Claude Code JSONL, Cursor exports, and more for token usage and costs. No API key needed.
